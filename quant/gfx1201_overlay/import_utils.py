...
def has_tilelang() -> bool:
    ...
    # gfx1201: importing tilelang aborts (TVM native lib foreign exception),
    # an uncatchable crash reached via get_quantization_config. ZAYA does not
    # use tilelang kernels, so report unavailable. (ZAYA-serving overlay.)
    return False
