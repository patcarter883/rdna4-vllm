...
class MoeWNA16Method(FusedMoEMethodBase):
    ...
    def get_weight_loader(layer, weight_loader):
        ...
        def moe_wna16_weight_loader(
            ...
            # RoutedExperts (the current MoE expert container) does not expose a
            # `tp_size` attribute like the legacy FusedMoE layer did; it lives on
            # its moe_config. Fall back to that so the AWQ/GPTQ MoE WNA16 path
            # works for RoutedExperts-based models (e.g. Qwen3.5 MoE).
